...
function transformForCompare(input){
  ...
  Object.keys(input).forEach(k=>{
    if(['id','title','price','cost_saving'].includes(k)) return;
    const v=input[k];
    if(isObj(v)){
  ...
  return { id: input.id||null, title: input.title||null, price: input.price||null, cost_saving: input.cost_saving||null, compareFields, compareTypes: types };
}
