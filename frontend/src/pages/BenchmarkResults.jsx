...
import PromptInput from "../components/ui/prompt/PromptInput.jsx";
import PromptForm from "../components/ui/prompt/PromptForm.jsx";
import {usePromptStore} from "../store/usePromptStore.js";
import GPTChatCard from "../components/ui/prompt/PromtChatCard.jsx";
...
function BenchmarkResults() {
    ...
    const descrition = `Choose the type of task to compare baseline vs optimized performance for ${getModelById(selectedModel)}`
            ...
            <div className="p-6">
                <div className="w-full flex justify-between">
                    ...
                    <div className="flex-1/3 flex justify-end items-end h-30">
                        { selectedTask &&  <div>
                            <Button variant="success" iconAfter={<ChevronRight />}>Next</Button>
