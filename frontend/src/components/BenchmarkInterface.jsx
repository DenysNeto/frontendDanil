...
const BenchmarkInterface = ({ prompt, promptKey, settings, models = [], title = 'Select Model' }) => {
...
//   const [response, setResponse] = useState('');
  ...
  const handlePrompt = useCallback(async (prompt) => {
    ...
    //         console.log('Token received:', data.content, 'Total chars:', responseRef.current.length); // Debug log
