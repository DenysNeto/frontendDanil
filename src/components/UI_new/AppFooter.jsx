...
export default function AppFooter() {
  return (
   <footer className={"bg-[#303030] text-white mt-30 z-2 py-10"}>
      ...
      <div className=" mx-auto grid grid-cols-1 md:grid-cols-2 gap-12  z-12">
      ...
      {footerColumns.map((column, colIndex) => (
        <ul key={colIndex}  className="flex flex-col-reverse space-y-1 border-l-1 pl-4 border-white/20">
